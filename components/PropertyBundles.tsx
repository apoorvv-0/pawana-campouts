  ...
  return (
    <section className={styles.section}>
      ...
      <div className={styles.grid}>
        {bundles.map((bundle) => {
          const saved = bundle.original_price - bundle.bundle_price;
          return (
            <div key={bundle.id} className={styles.card}>
              <div className={styles.badge}>
                <Zap size={12} /> You save ₹{saved.toLocaleString()}
              </div>
              <h3 className={styles.name}>{bundle.name}</h3>
              
              <div className={styles.included}>
                <div className={styles.includedTitle}>Everything included</div>
